...
% R2022a exportgraphics does not support SVG (verified at runtime).
% Native print preserves SVG text; retain the same strict design gate above.
set(fig,'PaperUnits','inches','PaperPosition',[0 0 fig.Position(3:4)],'PaperSize',fig.Position(3:4));
print(fig, pngPath, '-dpng', sprintf('-r%d',dpi));
export_editable_svg(fig,svgPath);
